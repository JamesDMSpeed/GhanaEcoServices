...
pd2000ghana2<-levelplot(pd2000ghana,margin=F,main='Population density',par.settings="YlOrRdTheme")
...
EcoSerLcov<-EcoSerLcov+geom_text(x=5,y=98, label="(d) Landcover")
...
Healthcaregroups<- data.frame(Groups=c("Anaesthetics", "Dentistry", "Dermatology", "Endocrinology", "Excipients", "Fever", "Immunology", "Infertility", "Malaria", "Musculoskeletal and cardiology", "Neurology", "Obstetrics and gynaecology", "Oncology", "Ophthalmology", "Orthopaedics", "Psychiatry"),
...
Groupsinhealthcare<- data.frame(Groups=c("Anaesthetics", "Dentistry", "Dermatology", "Endocrinology", "Excipients", "Fever", "Immunology", "Infertility", "Malaria","Musculoskeletal and cardiology", "Neurology", "Obstetrics and gynaecology", "Oncology", "Ophthalmology", "Orthopaedics", "Psychiatry"),
...
# Level plots with factors
GhanaLand2000<-levelplot(ghanalc2000_simple, col.regions=c("green4", "darkgoldenrod", 'midnightblue', 'indianred1', "grey10", "white","grey"),
          main = "Land cover 2000")
GhanaLand2000
...
>>>>>>> 472b73ed17ac1fe505a8c10c441d2db8e3a6c9d6
