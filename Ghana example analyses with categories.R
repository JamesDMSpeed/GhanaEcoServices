...
#Count GBIF records within Anaesthetics
with(droplevels(speciesdata[speciesdata$Group=='Medicine: Anaesthetics',]),tapply(GBIFrecswithconfirmendnames,Category,sum,na.rm=T))
